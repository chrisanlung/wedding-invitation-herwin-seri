...
/* Ekstensinya .m4a dan itu memang disengaja: berkasnya kontainer MP4 berisi
   AAC (ftyp/moov/mp4a), bukan MP3 - dicek dari byte awalnya, tidak ada
   sync-word MP3 sama sekali. Sewaktu masih bernama .mp3, server mengirim
   Content-Type: audio/mpeg yang tidak cocok dengan isinya. Chrome desktop
   memaafkan itu dan tetap memutar, tapi Safari iOS menolak - lagunya diam di
   HP dan tombol musiknya ikut mati karena <audio> memicu onError.

   Kalau menggantinya nanti: samakan ekstensi dengan isi berkasnya. MP3 asli
   -> .mp3, hasil unduhan YouTube/AAC -> .m4a. Jangan asal ganti nama. */
export const MUSIK = "/assets/bgm/menjadi-milikku.m4a";
